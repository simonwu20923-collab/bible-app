    ...
    return linesDriver.map((lineDriver, i) => {
      ...
      return (
        <div key={i} className="parallel-row">
          <div className={`parallel-col bible-text-${langA}`}>
            {leftLine !== null ? formatVerseLine(leftLine, 0) : <span className="parallel-unavailable">—</span>}
          </div>
          <div className={`parallel-col bible-text-${langB}`}>
                ...
                {verses ? parallelMode ? (
                  <>
                    ...
                    <div className="verses-text">
                      {formatVersesParallel(getTextForLang(parallelLangA, 'nt', false), getTextForLang(parallelLangB, 'nt', false), parallelLangA, parallelLangB)}
                    </div>
                  </>
                ) : (
              ...
              <div className={`verses-box${parallelMode ? ' verses-box-parallel' : ''}`}>
                {verses ? parallelMode ? (
                  <>
                    ...
                    <div className="verses-text">
                      {formatVersesParallel(getTextForLang(parallelLangA, 'ot', false), getTextForLang(parallelLangB, 'ot', false), parallelLangA, parallelLangB)}
                    </div>
                  </>
                ) : (
